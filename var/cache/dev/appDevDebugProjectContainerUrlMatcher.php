...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // page2
        if ('/page2' === $pathinfo) {
            return array (  '_controller' => 'AppBundle\\Controller\\AppController::page2Action',  '_route' => 'page2',);
        }

        // get_hello
        if (0 === strpos($pathinfo, '/api/hello') && preg_match('#^/api/hello(?:/(?P<astronaut>[^/]++))?$#s', $pathinfo, $matches)) {
